        ...
        <div className="lg:w-3/4 ">
          ...
          <div className="flex items-center gap-5 mt-8 lg:mt-16 lg:gap-10">
            <Link target="_blank" href={personalData.facebook}>
              <FaFacebook
                className="bg-[#8b98a5] p-3 rounded-full hover:bg-[#16f2b3] hover:scale-110 transition-all duration-300 text-blue-800 cursor-pointer"
                size={48}
              />
            </Link>
            <Link target="_blank" href={personalData.linkedIn}>
              <BiLogoLinkedin
                className="bg-[#8b98a5] p-3 rounded-full hover:bg-[#16f2b3] hover:scale-110 transition-all duration-300 text-blue-600 cursor-pointer"
                size={48}
              />
            </Link>
            <Link target="_blank" href={personalData.instagram}>
              <BsInstagram
                className="bg-[#8b98a5] p-3 rounded-full hover:bg-[#16f2b3] hover:scale-110 transition-all duration-300 text-[#C13584] cursor-pointer"
                size={48}
              />
            </Link>
            <Link target="_blank" href={personalData.fiverr}>
              <SiFiverr
                className="bg-[#8b98a5] p-3 rounded-full hover:bg-[#16f2b3] hover:text-white hover:scale-110 transition-all duration-300 text-green-400 cursor-pointer"
                size={48}
              />
            </Link>
